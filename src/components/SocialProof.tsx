      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {categories.map((cat, i) => (
            <div
              key={cat.label}
              className="group glass-card rounded-xl p-6 text-center hover-lift cursor-default"
              style={{ animationDelay: `${i * 50}ms` }}
            >
              <div className="w-10 h-10 mx-auto mb-3 rounded-lg bg-cyan/10 flex items-center justify-center text-cyan group-hover:bg-cyan/20 transition-colors">
                {cat.icon}
              </div>
